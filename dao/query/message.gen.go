...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.BotID = field.NewString(tableName, "bot_id")
	_message.ChatID = field.NewString(tableName, "chat_id")
	_message.Date = field.NewInt32(tableName, "date")
	_message.Content = field.NewString(tableName, "content")
	_message.RawContent = field.NewString(tableName, "raw_content")
	_message.AutoDelete = field.NewInt32(tableName, "auto_delete")
...
func (m *message) updateTableName(table string) *message {
	...
	m.BotID = field.NewString(table, "bot_id")
	m.ChatID = field.NewString(table, "chat_id")
	m.Date = field.NewInt32(table, "date")
	m.Content = field.NewString(table, "content")
	m.RawContent = field.NewString(table, "raw_content")
	m.AutoDelete = field.NewInt32(table, "auto_delete")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["raw_content"] = m.RawContent
	m.fieldMap["auto_delete"] = m.AutoDelete
}
